...
public class Worker_Registred_Hours {
    ...
    public Worker_Registred_Hours(Player player,String job,int page){
        this.player = player;
        this.job = job;
    ...
    private void createInventory(){
        ...
        File playerfolder = new File(main.getDataFolder() + "/saves/"+job, player.getName());
            ...
            if (files.length > 0){
                ...
                for (int i = index; i < (1 + page) * 36 && i < files.length; i++) {
                    ...
                    File sfile = files[i];
                        ...
                        lore.add(MessageUtils.getColoredMessage("#d86facWorker: &7&o"+ name));
                        lore.add(MessageUtils.getColoredMessage("#d86facJoin: &7&o"+join));
                        lore.add(MessageUtils.getColoredMessage("#d86facLeave: &7&o"+leave));
                        lore.add("  ");
                        lore.add(MessageUtils.getColoredMessage("&b&lTotal: &7&o"+ total));
                        meta.setLore(lore);
                ...
                ItemStack item = new ItemStack(Material.MAP);
                ItemMeta meta = item.getItemMeta();
                meta.setDisplayName(MessageUtils.getColoredMessage("&b&lTotal Time: &7&o"+String.valueOf(index)));
                List<String> lore = new ArrayList<>();
